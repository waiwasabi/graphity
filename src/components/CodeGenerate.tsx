...
export default function CodeGenerate() {
    ...
    return (
        <div className="justify-center text-center text-white">
            <div id='textbox' className="bg-[#324449] p-5 text-left font-mono rounded-lg border-4 overflow-scroll" style={{ minHeight: "32.5em", minWidth: "15em", maxHeight: "30em", maxWidth: "25em" }}>
